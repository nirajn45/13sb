      ...
      <div className="flex flex-col md:flex-row justify-center items-center mt-12 mx-auto p-6">
        <div className="w-full md:w-1/3 lg:w-1/4 mx-4 mb-8 md:mx-6">
          <div className="card glass">
            ...
            <div className="card-body">
              <h2 className="card-title text-xl md:text-2xl font-semibold">Effective Stain Removal</h2>
        ...
        <div className="w-full md:w-1/3 lg:w-1/4 mx-4 mb-8 md:mx-6">
          <div className="card glass">
            ...
            <div className="card-body">
              <h2 className="card-title text-xl md:text-2xl font-semibold">Organized Cleaning Schedule</h2>
        ...
        <div className="w-full md:w-1/3 lg:w-1/4 mx-4 mb-8 md:mx-6">
          <div className="card glass">
            ...
            <div className="card-body">
              <h2 className="card-title text-xl md:text-2xl font-semibold">Green Cleaning Solutions</h2>
